...
ActiveRecord::Schema[8.0].define(version: 2026_03_07_062543) do
  ...
  create_table "post_likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["author_id"], name: "index_post_likes_on_author_id"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "provider"
    t.string "uid"
    t.index "lower((name)::text)", name: "index_users_on_unique_name", unique: true
  ...
  add_foreign_key "post_likes", "users", column: "author_id"
